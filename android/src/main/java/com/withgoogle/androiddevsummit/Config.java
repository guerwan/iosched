...
package com.withgoogle.androiddevsummit;
...
public class Config {
    ...
    // Conference hashtag
    public static final String CONFERENCE_HASHTAG = "#AndroidDevSummit";
    ...
    public static final String CONFERENCE_HASHTAG_PREFIX = "#AndroidDevSummit";
    ...
    public static final long[][] CONFERENCE_DAYS = new long[][] {
            ...
            { ParserUtils.parseTime("2015-11-24T08:00:00.001Z"),
              ParserUtils.parseTime("2015-11-25T06:59:59.999Z") },
        };
    ...
    public static final String APP_NAME = "Android Dev Summit";
